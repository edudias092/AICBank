...
public class BankAccountReprovedMessageBuilder : IEmailMessageBuilder
{
    private const string TemplateFilePath = "wwwroot/templates/ContaPendente.template.html";
    private const string LogoFilePath = "wwwroot/images/logo.png";
    private readonly BankAccountDTO _bankAccountDto;
    private const string Subject = "Conta Pendente - AIC BANK";
    private List<EmailRecipient> _adminRecipients;

    public BankAccountReprovedMessageBuilder(BankAccountDTO bankAccountDto)
    {
